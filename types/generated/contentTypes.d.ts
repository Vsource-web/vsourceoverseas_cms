...
export interface ApiAdmissionEnquireAdmissionEnquire
  extends Struct.CollectionTypeSchema {
  collectionName: 'admission_enquires';
  info: {
    displayName: 'Admission Enquire';
    pluralName: 'admission-enquires';
    singularName: 'admission-enquire';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::admission-enquire.admission-enquire'
    > &
      Schema.Attribute.Private;
    number: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLandingPageLandingPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    country_names: Schema.Attribute.JSON & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    Students_Guided: Schema.Attribute.String & Schema.Attribute.Required;
    Study_in: Schema.Attribute.String & Schema.Attribute.Required;
    Title: Schema.Attribute.String & Schema.Attribute.Required;
    University_Partners: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::admission-enquire.admission-enquire': ApiAdmissionEnquireAdmissionEnquire;
